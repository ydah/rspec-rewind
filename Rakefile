...
task :mutation do
  ...
  sh 'bundle exec mutant run --require ./lib/rspec/rewind/core RSpec::Rewind::RetryDecision RSpec::Rewind::RetryPolicy RSpec::Rewind::RetryGate RSpec::Rewind::RetryCountResolver'
end
